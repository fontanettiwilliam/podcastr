...
export function Player(){
  const audioRef = useRef<HTMLAudioElement>(null)//é preciso criar uma referência para manipular tags html com JS no react
  ...
  useEffect(()=>{
    if (!audioRef.current){//current = valor da referencia (null)
      return;
    } 
    if(isPlaying){
  ...
  return(
    <div className={styles.playerContainer}>
        <header><img src="/playing.svg" alt="Tocando Agora"></img>
